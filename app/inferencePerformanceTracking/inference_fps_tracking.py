...
RUN_DURATION      = 30          # total seconds to run
FPS_LOG_INTERVAL  = 5           # print FPS to terminal every N seconds
frame_times       = collections.deque(maxlen=FPS_WINDOW)
fps_log           = []          # stores (timestamp, fps) snapshots
last_log_time     = None        # set once the loop starts
...
while True:
    ...
    # Every 5 seconds: log FPS to terminal
